...
hyperparameters = {
    "#_classes" : 1, #Si imposta come valore numero classi -1 per via dell'inizio dell'indice a 0
    "epochs": 5,
    "learning_rate": 1e-5,
    "batch_size": 8,
    "dropout": 0.1,
...
with open('test_loss_aug.pickle', 'wb') as f:
    pickle.dump(test_loss, f)
with open('train_acc_aug.pickle', 'wb') as f:
    pickle.dump(train_acc, f)
with open('validation_acc_aug.pickle', 'wb') as f:
    pickle.dump(validation_acc, f)
with open('test_acc_aug.pickle', 'wb') as f:
...
train_loss, validation_loss,test_loss, train_acc, validation_acc, test_acc = train_test(
                                                ...
                                                criterion,
                                                early_stopping,
                                                val_dataset_original_dataset)

with open('train_loss.pickle', 'wb') as f:
    pickle.dump(train_loss, f)
with open('validation_loss.pickle', 'wb') as f:
    pickle.dump(validation_loss, f)
with open('test_loss.pickle', 'wb') as f:
    pickle.dump(test_loss, f)
with open('train_acc.pickle', 'wb') as f:
    pickle.dump(train_acc, f)
with open('validation_acc.pickle', 'wb') as f:
    pickle.dump(validation_acc, f)
with open('test_acc.pickle', 'wb') as f:
    pickle.dump(test_acc, f)